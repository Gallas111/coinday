    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 flex-1">
        ...
        <div className="prose text-foreground space-y-6 text-sm leading-relaxed">
          ...
          <p>
            Coinday(이하 &quot;사이트&quot;, coindaynow.com)는 이용자의
          ...
          <section>
            <h2>자체 방문 통계 (쿠키를 사용하지 않습니다)</h2>
            <p>
              본 사이트는 어느 글이 얼마나 읽히는지 파악하기 위해 자체 방문 통계를 운영합니다. 페이지 조회, 스크롤 위치, 머문 시간, 외부 링크 클릭을 기록하며 <strong>쿠키를 사용하지 않습니다</strong>. 방문을 구분하는 값은 브라우저 탭에만 저장되어 탭을 닫으면 사라집니다. IP 주소와 브라우저 정보 원문은 저장하지 않고, 기기 종류·운영체제·브라우저·국가로만 바꿔 보관합니다. 따라서 이 통계만으로는 개인을 식별할 수 없습니다.
            </p>

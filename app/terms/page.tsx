...
export const metadata: Metadata = {
  title: "이용약관",
  description: "Coinday 블로그 이용약관입니다.",
  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 flex-1">
        <h1 className="text-2xl md:text-3xl font-bold text-[var(--accent-strong)] mb-8">
          이용약관
        </h1>
        <div className="prose text-foreground space-y-6 text-sm leading-relaxed">
          ...
          <section>
            <h2>제1조 (목적)</h2>
            <p>
              본 약관은 Coinday(이하 &quot;사이트&quot;, coindaynow.com)가
          ...
          <section>
            ...
            <ol>
              <li>
                &quot;사이트&quot;란 Coinday가 운영하는 인터넷 블로그
                (coindaynow.com)를 말합니다.
              </li>
              <li>
          ...
          <section>
            <h2>제4조 (서비스의 내용)</h2>
            <p>
              사이트는 미국 배당주, 월배당 ETF, 포트폴리오 시뮬레이션, 미국 주식
              세금·환율, 거시 시장 흐름에 관한 정보성 콘텐츠를 제공합니다. 본 사이트의
              콘텐츠는 객관 데이터·시뮬레이션 기반 정보 제공 목적이며, 특정 종목·ETF의
              매수·매도 권유나 투자 자문이 아닙니다. 투자 결정에 따른 모든 손익은
              이용자 본인에게 귀속되며, 전문적인 재정·세무 자문을 대체하지 않습니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              저작권 및 지식재산권은 Coinday에 귀속됩니다. 이용자는 사이트

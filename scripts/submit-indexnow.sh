...
# Usage: bash scripts/submit-indexnow.sh https://www.bukbukstock.com/blog/new-post-slug

SITE_URL="$1"
KEY="b3f8a2d1e5c94f7689012345abcdef67"
HOST="www.bukbukstock.com"

if [ -z "$SITE_URL" ]; then
  echo "Usage: bash scripts/submit-indexnow.sh <full-url>"
  echo "Example: bash scripts/submit-indexnow.sh https://www.bukbukstock.com/blog/example-post"
  exit 1
fi

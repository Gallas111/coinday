        ...
        >
          {page > 1 && (
            <button
              ...
              className="px-3.5 py-2.5 sm:px-3 sm:py-2 text-sm text-muted hover:text-[var(--accent)] border border-[var(--border)] rounded-lg hover:border-[var(--accent)] transition-colors"
            >
              ← 이전
            </button>
          )}
            ...
            <button
              ...
              className={`px-3.5 py-2.5 sm:px-3 sm:py-2 text-sm rounded-lg transition-colors ${
                p === page
                  ...
                  : "text-muted hover:text-[var(--accent)] border border-[var(--border)] hover:border-[var(--accent)]"
              }`}
            >
              {p}
            </button>
